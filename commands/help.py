        ...
        if value == "info":
            ...
            embed = build_embed(
                ...
                (
                    ...
                    "**Gacha Limbus, Blue Archive, FGO & Brown Dust 2**\n"
                    "`/gacha [game] [pulls] [server] [target]` — Mặc định là "
                    ...
                    "JP/Global/CN hiện tại; chọn FGO để quay ×1/×11 trong FGO "
                    "Summon Simulator NA/JP; chọn Brown Dust 2 để quay Costume "
                    "×1/×10 với bảo hiểm 4★/5★ và pool thường không limited.\n"
                    ...
                    "collection và cộng 1 Extraction Point mỗi lượt. Điểm hoạt động dùng hệ số "
                    "×2 ngày thường, ×5 cuối tuần; kênh Economy cũng nhận thông báo bắt đầu/kết "
                    "thúc event.\n\n"
